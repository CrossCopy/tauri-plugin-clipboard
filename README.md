...
```toml
tauri-plugin-clipboard = { git = "https://github.com/CrossCopy/tauri-plugin-clipboard", tag = "v0.6.4" }
```
...
npm i https://github.com/CrossCopy/tauri-plugin-clipboard#v0.6.4 # or this for tag
```
